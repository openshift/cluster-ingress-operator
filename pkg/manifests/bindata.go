...
// manifests/02-deployment.yaml (2.468kB)
...
func manifests02DeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "manifests/02-deployment.yaml", size: 2468, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xbf, 0x8d, 0xe3, 0x66, 0x2e, 0xe7, 0xfd, 0x1, 0xc, 0xbf, 0xaf, 0xe9, 0x99, 0xac, 0xb, 0xcd, 0xd4, 0x99, 0xf, 0xbc, 0x4f, 0xd1, 0xcc, 0x9f, 0x1, 0xc3, 0x68, 0xa5, 0xb7, 0x62, 0xe5, 0xeb}}
	return a, nil
}
