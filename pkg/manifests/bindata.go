...
// manifests/02-deployment.yaml (2.836kB)
...
func manifests02DeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "manifests/02-deployment.yaml", size: 2836, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xad, 0xff, 0x4d, 0x1d, 0x13, 0x30, 0xdd, 0x9e, 0x7b, 0x68, 0x52, 0xa0, 0x87, 0x61, 0xd3, 0xb0, 0xd6, 0x65, 0x9a, 0xaf, 0xf6, 0x86, 0xba, 0x85, 0xb2, 0x95, 0x42, 0xf5, 0x6a, 0xcb, 0xef, 0x8a}}
	return a, nil
}
