...
func assetsRouterClusterRoleYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/router/cluster-role.yaml", size: 705, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
