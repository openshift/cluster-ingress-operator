...
// manifests/00-cluster-role.yaml (1.225kB)
...
func manifests00ClusterRoleYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "manifests/00-cluster-role.yaml", size: 1225, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x23, 0x72, 0x46, 0x20, 0xd2, 0x4, 0x79, 0xf9, 0x19, 0x6c, 0xa6, 0x95, 0xb1, 0xb8, 0x78, 0xc, 0xf0, 0x74, 0xdd, 0x94, 0x4d, 0xdc, 0xdb, 0x66, 0x35, 0x48, 0x6e, 0xaf, 0x5, 0x4d, 0xf9, 0xa3}}
	return a, nil
}
