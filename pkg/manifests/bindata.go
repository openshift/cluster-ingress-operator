...
func assetsDefaultsClusterIngressYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/defaults/cluster-ingress.yaml", size: 586, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
