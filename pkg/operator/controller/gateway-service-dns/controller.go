...
func NewUnmanaged(mgr manager.Manager, config Config) (controller.Controller, error) {
	...
	gatewayListenersChanged := predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			// TODO - revisit if we determine that backendRefs changes matter.
	...
	gatewayToService := func(ctx context.Context, o client.Object) []reconcile.Request {
		...
		listOpts := []client.ListOption{
			...
			// TODO - revisit if we plan to watch other namespaces.
	...
	if err := c.Watch(source.Kind[client.Object](operatorCache, &iov1.DNSRecord{}, handler.EnqueueRequestForOwner(scheme, mapper, &corev1.Service{}), isInOperandNamespace, isDNSRecordForGatewayAPI)); err != nil {
		return nil, err
	}
	return c, nil
}
