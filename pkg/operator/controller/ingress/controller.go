	...
	case operatorv1.LoadBalancerServiceStrategyType:
		...
		case operatorv1.AWSLoadBalancerProvider:
			...
			if statusLB.ProviderParameters.AWS.Type == operatorv1.AWSNetworkLoadBalancer {
				...
				var specProtocol operatorv1.IngressControllerProtocol
...
func setDefaultProviderParameters(lbs *operatorv1.LoadBalancerStrategy, ingressConfig *configv1.Ingress, alreadyAdmitted bool) {
	...
	case operatorv1.AWSLoadBalancerProvider:
		...
		case operatorv1.AWSNetworkLoadBalancer:
			...
			if !alreadyAdmitted && len(lbs.ProviderParameters.AWS.NetworkLoadBalancerParameters.Protocol) == 0 {
				lbs.ProviderParameters.AWS.NetworkLoadBalancerParameters.Protocol = operatorv1.ProxyProtocol
			}
		}
	...
	case operatorv1.LoadBalancerServiceStrategyType:
		...
		case configv1.AWSPlatformType:
			...
			if lbType == operatorv1.AWSNetworkLoadBalancer &&
				...
				ic.Status.EndpointPublishingStrategy.LoadBalancer.ProviderParameters.AWS.NetworkLoadBalancerParameters.Protocol == operatorv1.ProxyProtocol {
				return true, nil
			}
			return false, nil
