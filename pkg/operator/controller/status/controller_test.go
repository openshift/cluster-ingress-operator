	...
	testCases := []struct {
		...
		},
		{
			...
			expectCondition: configv1.ClusterOperatorStatusCondition{
				Type:    configv1.OperatorDegraded,
				Status:  configv1.ConditionTrue,
				Reason:  "GatewayAPIInstallBlocked",
				Message: "Package sailoperator from subscription foo/sailoperator prevents enabling operator-managed Gateway API. Remove subscription foo/sailoperator to enable.",
			},
		},
		{
			...
			expectCondition: configv1.ClusterOperatorStatusCondition{
				...
				Status:  configv1.ConditionTrue,
				Reason:  "GatewayAPIInstallBlocked",
				Message: "Installed version servicemeshoperator3.v3.0.0 is too old to support operator-managed Gateway API. Install version servicemeshoperator3.v3.1.0 or remove subscription foo/servicemeshoperator3 to enable.\nPackage sailoperator from subscription foo/sailoperator prevents enabling operator-managed Gateway API. Remove subscription foo/sailoperator to enable.",
			},
		},
		{
			...
			expectCondition: configv1.ClusterOperatorStatusCondition{
				Type:    configv1.OperatorDegraded,
				Status:  configv1.ConditionFalse,
				Reason:  "IngressNotDegradedAndGatewayAPIInstallSuccessful",
