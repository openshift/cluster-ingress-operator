...
func (r *reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	allIngressesAvailable := checkAllIngressesAvailable(state.IngressControllers, state.externalTopologyMode)
...
// checkAllIngressesAvailable checks if all expected ingress controllers are available.
func checkAllIngressesAvailable(ingresses []operatorv1.IngressController, externalTopologyMode bool) bool {
	...
	return len(ingresses) != 0 || externalTopologyMode
}
