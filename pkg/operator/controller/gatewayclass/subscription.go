...
func (r *reconciler) ensureServiceMeshOperatorSubscription(ctx context.Context, channel, version string) (bool, *operatorsv1alpha1.Subscription, error) {
	...
	desired, err := desiredSubscription(name, channel, version)
	if err != nil {
