...
SUPPORTED_FEATURES="ReferenceGrant,HTTPRoute,Gateway,GatewayHTTPListenerIsolation,HTTPRoutePathRedirect,HTTPRouteParentRefPort,HTTPRouteDestinationPortMatching,HTTPRouteBackendRequestHeaderModification,HTTPRoutePathRewrite,HTTPRoutePortRedirect,GatewayStaticAddresses,HTTPRouteRequestTimeout,HTTPRouteResponseHeaderModification,HTTPRoute308RedirectStatusCode,HTTPRouteHostRewrite,GatewayPort8080,HTTPRouteSchemeRedirect,GatewayInfrastructurePropagation,HTTPRouteRequestMultipleMirrors,HTTPRouteBackendTimeout,HTTPRouteRequestPercentageMirror,HTTPRoute307RedirectStatusCode,HTTPRouteMethodMatching,HTTPRouteCORS,BackendTLSPolicySANValidation,HTTPRouteBackendProtocolWebSocket,HTTPRouteQueryParamMatching,HTTPRouteRequestMirror,GatewayAddressEmpty,BackendTLSPolicy,HTTPRouteBackendProtocolH2C,HTTPRoute303RedirectStatusCode,HTTPRouteNamedRouteRule,GRPCRoute,TLSRoute,TLSRouteModeTerminate,TLSRouteModeMixed"
...
SKIPPED_TESTS="BackendTLSPolicyConflictResolution,GatewayBackendClientCertificate,GatewayFrontendClientCertificateValidation,GatewayFrontendClientCertificateValidationInsecureFallback,GatewayHTTPSListenerDetectMisdirectedRequests,ListenerSet" 
