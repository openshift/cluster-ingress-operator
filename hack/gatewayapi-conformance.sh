...
SUPPORTED_FEATURES="Gateway,ReferenceGrant,HTTPRoute,GatewayHTTPListenerIsolation,HTTPRoutePortRedirect,HTTPRouteRequestTimeout,HTTPRouteParentRefPort,HTTPRouteSchemeRedirect,HTTPRoutePathRewrite,HTTPRouteHostRewrite,HTTPRouteRequestMirror,HTTPRouteResponseHeaderModification,BackendTLSPolicy,HTTPRouteBackendRequestHeaderModification,HTTPRoutePathRedirect,GatewayInfrastructurePropagation,HTTPRouteMethodMatching,HTTPRouteNamedRouteRule,HTTPRouteCORS,HTTPRouteBackendProtocolH2C,HTTPRouteBackendProtocolWebSocket,GatewayAddressEmpty,HTTPRouteDestinationPortMatching,HTTPRouteBackendTimeout,HTTPRouteRequestMultipleMirrors,BackendTLSPolicySANValidation,HTTPRouteQueryParamMatching,GatewayPort8080,HTTPRouteRequestPercentageMirror,GRPCRoute"
