...
type IstioSpec struct {
	...
	// Must be one of: v1.30-latest, v1.30.4, v1.30.3, v1.30.1, v1.28-latest, v1.28.10, v1.28.8, v1.28.6, v1.28.5, v1.28.4, v1.27-latest, v1.27.9, v1.27.8, v1.27.5, v1.27.3.
	// +operator-sdk:csv:customresourcedefinitions:type=spec,order=1,displayName="Istio Version",xDescriptors={"urn:alm:descriptor:com.tectonic.ui:fieldGroup:General", "urn:alm:descriptor:com.tectonic.ui:select:v1.30-latest", "urn:alm:descriptor:com.tectonic.ui:select:v1.30.4", "urn:alm:descriptor:com.tectonic.ui:select:v1.30.3", "urn:alm:descriptor:com.tectonic.ui:select:v1.30.1", "urn:alm:descriptor:com.tectonic.ui:select:v1.28-latest", "urn:alm:descriptor:com.tectonic.ui:select:v1.28.10", "urn:alm:descriptor:com.tectonic.ui:select:v1.28.8", "urn:alm:descriptor:com.tectonic.ui:select:v1.28.6", "urn:alm:descriptor:com.tectonic.ui:select:v1.28.5", "urn:alm:descriptor:com.tectonic.ui:select:v1.28.4", "urn:alm:descriptor:com.tectonic.ui:select:v1.27-latest", "urn:alm:descriptor:com.tectonic.ui:select:v1.27.9", "urn:alm:descriptor:com.tectonic.ui:select:v1.27.8", "urn:alm:descriptor:com.tectonic.ui:select:v1.27.5", "urn:alm:descriptor:com.tectonic.ui:select:v1.27.3"}
	// +kubebuilder:validation:Enum=v1.30-latest;v1.30.4;v1.30.3;v1.30.1;v1.28-latest;v1.28.10;v1.28.8;v1.28.6;v1.28.5;v1.28.4;v1.27-latest;v1.27.9;v1.27.8;v1.27.5;v1.27.3;v1.26-latest;v1.26.8;v1.26.6;v1.26.4;v1.26.3;v1.26.2
	// +kubebuilder:default=v1.30.4
...
type Istio struct {
	...
	// +kubebuilder:default={version: "v1.30.4", namespace: "istio-system", updateStrategy: {type:"InPlace"}}
	// +optional
