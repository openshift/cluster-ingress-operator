...
// size significantly (~50-100MB) as it includes all chart files.
//
...
//
// This package is intended for consumers (like OpenShift Ingress) who want
// to embed the charts directly in their binary.
//
// Usage:
//
