...
type OpenStackLoadBalancerParameters struct {
	...
	// A user can use that so they can specific which address to use for a given load balancer
	// instead of getting a random one from the cloud-provider-openstack.
