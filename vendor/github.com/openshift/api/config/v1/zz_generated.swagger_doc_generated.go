...
var map_IngressSpec = map[string]string{
	...
	"operatorLogLevel":     "logLevel describes the desired logging verbosity for the Ingress Operator Any one of the following values may be specified: * Normal * Debug Defaults to \"Normal\".",
}
