# Ingress Operator QE Tests

QE-created tests in `test/qe/ingress_operator.go` validate IngressController lifecycle, router deployment behavior, and ingress operator functionality. Shared utilities are in `test/qe/ingress_operator_util.go`.
