...
# Copy Gateway API manifests used on the current build so users can later rollback
# changes if they want to go back to Gateway API Managed mode and need to fetch
# the right manifests to reapply them on the cluster.
