...
require (
	...
	github.com/openshift/api v0.0.0-20260211200342-8ef4bf7dc587
...
replace github.com/istio-ecosystem/sail-operator => github.com/aslakknutsen/sail-operator v0.0.0-20260212203141-0104835c4935
