...
require (
	...
	k8s.io/api v0.34.3 // Replaced at bottom of file; see replace directives for actual version used.
	k8s.io/apiextensions-apiserver v0.34.3 // Replaced at bottom of file; see replace directives for actual version used.
	k8s.io/apimachinery v0.34.3 // Replaced at bottom of file; see replace directives for actual version used.
	k8s.io/apiserver v0.34.3 // Replaced at bottom of file; see replace directives for actual version used.
	k8s.io/client-go v12.0.0+incompatible // Replaced at bottom of file; see replace directives for actual version used.
	k8s.io/utils v0.0.0-20250820121507-0af2bda4dd1d
	sigs.k8s.io/controller-runtime v0.22.5 // Replaced at bottom of file; see replace directives for actual version used.
	sigs.k8s.io/gateway-api v1.4.0 // Replaced at bottom of file; see replace directives for actual version used.
)
...
// Pin k8s and controller-runtime to 4.20 versions to prevent
...
replace (
	...
	sigs.k8s.io/gateway-api => sigs.k8s.io/gateway-api v1.2.1
)

replace github.com/openshift/api => github.com/gcs278/api v0.0.0-20260515020707-697ef2e02b5d
