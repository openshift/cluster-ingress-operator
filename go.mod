...
require (
	...
	istio.io/client-go v1.30.0-alpha.1.0.20260502131957-7307deff563c // indirect
	istio.io/istio v0.0.0-20260506004247-d90b05fe8e88 // indirect
...
replace github.com/istio-ecosystem/sail-operator => github.com/dgn/sail-operator v0.0.0-20260507193005-f8f03773cf36
