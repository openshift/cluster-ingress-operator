...
require (
	...
	github.com/openshift/api v0.0.0-20260602200800-1d79f30d4668
	...
	sigs.k8s.io/gateway-api v1.4.1 // Replaced at bottom of file; see replace directives for actual version used.
)
